...
import pyignition.PyIgnition, pygame, sys, math
...
effect = pyignition.PyIgnition.ParticleEffect(screen, (0, 0), (800, 600))
source = effect.CreateSource((0, 0), initspeed = 2.0, initdirection = math.pi, initspeedrandrange = 1.0, initdirectionrandrange = math.pi, particlesperframe = 20, particlelife = 80, drawtype = pyignition.PyIgnition.DRAWTYPE_CIRCLE, colour = (100, 100, 250), radius = 10.0)
...
rect1.CreateKeyframe(200, pos = (400, 100), width = 400.0, interpolationtype = pyignition.PyIgnition.INTERPOLATIONTYPE_COSINE)
rect1.CreateKeyframe(300, colour = (255, 0, 0))
circle2.CreateKeyframe(250, pos = (400, 500), interpolationtype = pyignition.PyIgnition.INTERPOLATIONTYPE_COSINE)
circle2.CreateKeyframe(300, colour = (0, 255, 50))
circle4.CreateKeyframe(200, pos = circle4.pos)
circle4.CreateKeyframe(230, pos = (100, 300), interpolationtype = pyignition.PyIgnition.INTERPOLATIONTYPE_COSINE)
