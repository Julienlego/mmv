...
from src.pyignition import keyframes, interpolate
import random, math, pygame
from src.pyignition.constants import *


class Particle:
    def __init__(self, parent, initpos, velocity, life, drawtype=DRAWTYPE_POINT, colour=(0, 0, 0), radius=0.0,
...
class ParticleSource:
    ...
    def CreateParticle(self):
        ...
        newparticle = Particle(self, initpos=self.pos, velocity=velocity, life=self.particlelife,
